...
public class Fire {
    ...
    public void HeatBlast() {
        int damage = random.nextInt(10) + 15; 
        System.out.println(name + " used HEAV BLAST " + damage  );
        
    }

    public void RagingFury() {
        int weaken = random.nextInt(4) + 1; 
        System.out.println(name + " used Raging Furry: minus " + weaken + "defense to the enemy");
